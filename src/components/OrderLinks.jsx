...
export default function OrderLinks() {
  ...
  return (
    <section className="flex flex-col items-center bg-neutral-900/60 p-8 md:p-10 rounded-[2rem] border border-neutral-800/80 shadow-xl backdrop-blur-md relative">
      ...
      {/* Container com Grid para organizar os 4 botões perfeitamente */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl">
        
        {/* Botão Meu Carrinho (Cardápio Principal) - AGORA AZUL */}
        <button 
          onClick={(e) => handleRedirect(e, 'https://meucarrinho.delivery/destaklanches')}
          className="flex items-center justify-center px-6 py-4 bg-blue-600 hover:bg-blue-500 transition-all transform hover:scale-105 active:scale-95 rounded-xl font-bold text-white shadow-lg w-full border border-blue-500/50"
        >
          <img src="/meucarrinho.png" alt="Meu Carrinho" className="w-6 h-6 mr-3 object-contain" />
          Cardápio Oficial
        </button>
        ...
        <button 
          ...
          className="flex items-center justify-center px-6 py-4 bg-red-600 hover:bg-red-500 transition-all transform hover:scale-105 active:scale-95 rounded-xl font-bold text-white shadow-lg w-full border border-red-500/50"
        >
        ...
        {/* Botão 99 Food */}
        <button 
          onClick={(e) => handleRedirect(e, 'https://oia.99app.com/dlp9/trsvoi')}
          className="flex items-center justify-center px-6 py-4 bg-yellow-500 hover:bg-yellow-400 transition-all transform hover:scale-105 active:scale-95 rounded-xl font-bold text-black shadow-lg w-full border border-yellow-400/50"
        >
          <img src="/food.png" alt="99 Food" className="w-6 h-6 mr-3 object-contain" />
          Pedir no 99 Food
        </button>
        ...
        <button 
          ...
          className="flex items-center justify-center px-6 py-4 bg-green-600 hover:bg-green-500 transition-all transform hover:scale-105 active:scale-95 rounded-xl font-bold text-white shadow-lg w-full border border-green-500/50"
        >
